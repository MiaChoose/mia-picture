...
import com.lumenglover.miapicturebackend.model.dto.picture.PictureHotScoreDto;
...
public class PictureRecommendScoreJob implements CommandLineRunner {
    ...
    @Resource
    private com.lumenglover.miapicturebackend.service.UserService userService;
    ...
    private boolean isBotUser(Long userId) {
        ...
        try {
            com.lumenglover.miapicturebackend.model.entity.User user = userService.getById(userId);
