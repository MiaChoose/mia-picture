...
import com.lumenglover.miapicturebackend.model.dto.user.*;
import com.lumenglover.miapicturebackend.model.dto.user.UserUpdatePermissionsRequest;
import com.lumenglover.miapicturebackend.model.dto.user.UserMultiDeviceLoginUpdateRequest;
...
public class UserController {
    ...
    @Resource
    private com.lumenglover.miapicturebackend.manager.QrLoginManager qrLoginManager;

    @Resource
    private com.lumenglover.miapicturebackend.service.UserLoginRecordService userLoginRecordService;
    ...
    public BaseResponse<Boolean> checkWxUnbindStatus(@RequestParam("sceneId") String sceneId, HttpServletRequest request) {
        ...
        if ("WAITING".equals(status)) {
            ...
            com.lumenglover.miapicturebackend.model.entity.User loginUser = userService.getLoginUser(request);
