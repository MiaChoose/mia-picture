...
import com.lumenglover.miapicturebackend.model.dto.rag.SessionDeleteRequest;
import com.lumenglover.miapicturebackend.model.dto.rag.SessionQueryRequest;
import com.lumenglover.miapicturebackend.model.dto.rag.SessionSwitchRequest;
...
import com.lumenglover.miapicturebackend.model.vo.RagSessionVO;
...
public class SessionController {
    ...
    @Resource
    private com.lumenglover.miapicturebackend.service.RagSessionMessageService ragSessionMessageService;
    ...
    public BaseResponse<String> autoNameSession(@RequestBody SessionQueryRequest sessionQueryRequest, HttpServletRequest request) {
        ...
        // 取该会话的第一条用户消息
        com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<com.lumenglover.miapicturebackend.model.entity.RagSessionMessage> qw =
        ...
        com.lumenglover.miapicturebackend.model.entity.RagSessionMessage firstMsg =
