...
import com.lumenglover.miapicturebackend.service.PythonApiService;
...
public class PythonApiController {
    ...
    @com.lumenglover.miapicturebackend.annotation.RateLimiter(key = "ai_remove_bg", time = 60, count = 5, message = "AI 抠图过于频繁，请稍后再试")
    ...
    @com.lumenglover.miapicturebackend.annotation.RateLimiter(key = "ai_face_blur", time = 60, count = 5, message = "人脸打码过于频繁，请稍后再试")
    ...
    @AuthCheck(mustRole = UserConstant.DEFAULT_ROLE)
    @com.lumenglover.miapicturebackend.annotation.RateLimiter(key = "ai_change_bg", time = 60, count = 5, message = "更换背景过于频繁，请稍后再试")
    ...
    @AuthCheck(mustRole = UserConstant.DEFAULT_ROLE)
    @com.lumenglover.miapicturebackend.annotation.RateLimiter(key = "ai_enhance_image", time = 60, count = 5, message = "增强清晰度过于频繁，请稍后再试")
