...
import com.lumenglover.miapicturebackend.model.dto.rag.QaMessageAddRequest;
import com.lumenglover.miapicturebackend.model.dto.rag.QaMessageQueryRequest;
import com.lumenglover.miapicturebackend.model.entity.RagSessionMessage;
import com.lumenglover.miapicturebackend.model.entity.RagUserSession;
import com.lumenglover.miapicturebackend.model.entity.User;
import com.lumenglover.miapicturebackend.model.vo.RagMessageVO;
import com.lumenglover.miapicturebackend.service.RagSessionMessageService;
import com.lumenglover.miapicturebackend.service.RagUserSessionService;
import com.lumenglover.miapicturebackend.service.RagService;
import com.lumenglover.miapicturebackend.service.UserService;
import com.lumenglover.miapicturebackend.service.AiTokenRecordService;
import com.lumenglover.miapicturebackend.service.AiResourceService;
...
public class MessageQaController {
    ...
    @Resource
    private com.lumenglover.miapicturebackend.service.PythonRagService pythonRagService;
    ...
    public BaseResponse<RagMessageVO> getQaAnswer(@RequestBody QaMessageQueryRequest messageQueryRequest,
        ...
        try {
            ...
            com.lumenglover.miapicturebackend.model.dto.rag.PythonRagResponse response = ragService.chat(userId,
    ...
    @AuthCheck(mustRole = UserConstant.DEFAULT_ROLE)
    public BaseResponse<com.lumenglover.miapicturebackend.model.vo.AiTokenUsageVO> getAiTokenUsage(
            HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
