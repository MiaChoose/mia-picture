...
import com.lumenglover.miapicturebackend.constant.CategoryConstant;
...
import com.lumenglover.miapicturebackend.model.vo.CategoryVO;
...
public class CategoryController {
   ...
   @RateLimiter(key = "category_list_by_type", time = 60, count = 60, message = "分类列表查询过于频繁，请稍后再试")
