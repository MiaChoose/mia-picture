package com.lumenglover.miapicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // mia_picture.picture_112321321,mia_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "mia_picture." + tableName) // 确保前缀合法
