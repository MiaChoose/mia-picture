...
import com.lumenglover.miapicturebackend.constant.CommonValue;
...
import com.lumenglover.miapicturebackend.manager.FileManager;
import com.lumenglover.miapicturebackend.manager.WxLoginManager;
import com.lumenglover.miapicturebackend.manager.auth.StpKit;
import com.lumenglover.miapicturebackend.mapper.UserMapper;
import com.lumenglover.miapicturebackend.mapper.InviteRecordMapper;
...
import com.lumenglover.miapicturebackend.model.dto.user.UserModifyPassWord;
import com.lumenglover.miapicturebackend.model.dto.user.UserQueryRequest;
import com.lumenglover.miapicturebackend.model.dto.user.UserExportRequest;
import com.lumenglover.miapicturebackend.model.entity.*;
import com.lumenglover.miapicturebackend.model.enums.SpaceLevelEnum;
import com.lumenglover.miapicturebackend.model.enums.UserRoleEnum;
import com.lumenglover.miapicturebackend.model.vo.LoginUserVO;
import com.lumenglover.miapicturebackend.model.vo.SafeUserVO;
import com.lumenglover.miapicturebackend.model.vo.UserPublicVO;
...
import com.lumenglover.miapicturebackend.service.PostAttachmentService;
import com.lumenglover.miapicturebackend.service.ViewRecordService;
import com.lumenglover.miapicturebackend.service.SystemNotifyService;
import com.lumenglover.miapicturebackend.service.SpaceService;
...
import com.lumenglover.miapicturebackend.utils.DefaultAvatarUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    private void calculateAndUpgradeMember(Long userId) {
        ...
        com.lumenglover.miapicturebackend.model.enums.SpaceLevelEnum levelEnum =
            com.lumenglover.miapicturebackend.model.enums.SpaceLevelEnum.getEnumByValue(this.isAdmin(user) ? 2 : memberType);
        if (levelEnum == null) {
            levelEnum = com.lumenglover.miapicturebackend.model.enums.SpaceLevelEnum.COMMON;
        }
        int newMaxStorage = levelEnum.getMaxStorage();

        spaceService.lambdaUpdate()
                .set(com.lumenglover.miapicturebackend.model.entity.Space::getMaxStorage, newMaxStorage)
                .set(com.lumenglover.miapicturebackend.model.entity.Space::getSpaceLevel, levelEnum.getValue())
                .set(com.lumenglover.miapicturebackend.model.entity.Space::getMaxCount, levelEnum.getMaxCount())
                .set(com.lumenglover.miapicturebackend.model.entity.Space::getMaxSize, levelEnum.getMaxSize())
                .eq(com.lumenglover.miapicturebackend.model.entity.Space::getUserId, userId)
                .update();
