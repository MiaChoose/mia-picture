...
import com.lumenglover.miapicturebackend.mapper.AuthorRankingMapper;
import com.lumenglover.miapicturebackend.model.entity.AuthorRanking;
import com.lumenglover.miapicturebackend.model.entity.User;
import com.lumenglover.miapicturebackend.model.enums.AuthorRankingTypeEnum;
import com.lumenglover.miapicturebackend.model.enums.TimeRangeEnum;
import com.lumenglover.miapicturebackend.model.vo.AuthorRankingVO;
import com.lumenglover.miapicturebackend.model.vo.FollowersAndFansVO;
import com.lumenglover.miapicturebackend.service.AuthorRankingService;
import com.lumenglover.miapicturebackend.service.UserFollowsService;
...
public class AuthorRankingServiceImpl extends ServiceImpl<AuthorRankingMapper, AuthorRanking>
    ...
    @Resource
    private com.lumenglover.miapicturebackend.service.PictureService pictureService;

    @Resource
    private com.lumenglover.miapicturebackend.service.PostService postService;

    @Resource
    private com.lumenglover.miapicturebackend.manager.RankingRedisManager rankingRedisManager;
    ...
    private List<?> getRecentWorks(Long userId, String rankingType) {
        ...
        if (AuthorRankingTypeEnum.PICTURE.getValue().equals(rankingType)) {
            ...
            com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.lumenglover.miapicturebackend.model.entity.Picture> page =
                    new com.baomidou.mybatisplus.extension.plugins.pagination.Page<>(1, 4);
            QueryWrapper<com.lumenglover.miapicturebackend.model.entity.Picture> wrapper = new QueryWrapper<>();
            ...
            com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.lumenglover.miapicturebackend.model.entity.Picture> resultPage =
            ...
            com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.lumenglover.miapicturebackend.model.entity.Post> page =
                    new com.baomidou.mybatisplus.extension.plugins.pagination.Page<>(1, 4);
            QueryWrapper<com.lumenglover.miapicturebackend.model.entity.Post> wrapper = new QueryWrapper<>();
            wrapper.eq("userId", userId)
                    .eq("status", 1)          // 审核通过
                    .eq("isDelete", 0)        // 未删除
                    .orderByDesc("createTime")
            ...
            com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.lumenglover.miapicturebackend.model.entity.Post> resultPage =
