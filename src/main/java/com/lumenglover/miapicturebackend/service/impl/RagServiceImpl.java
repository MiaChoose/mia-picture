...
import com.lumenglover.miapicturebackend.model.entity.RagMemory;
...
public class RagServiceImpl implements RagService {
    ...
    @Override
    public com.lumenglover.miapicturebackend.model.dto.rag.PythonRagResponse chat(Long userId, Long sessionId,
                                                                                  String question, String saToken) {
        if (StrUtil.isBlank(question)) {
            log.warn("【RAG问答】问题为空 | 用户ID: {} | 会话ID: {}", userId, sessionId);
            return com.lumenglover.miapicturebackend.model.dto.rag.PythonRagResponse.builder().answer("请输入您想咨询的问题。")
                    .build();
        }
    ...
    private String processSearchTokens(String content, String saToken) {
        ...
        try {
            ...
            while (matcher.find()) {
                ...
                // 执行搜索
                com.lumenglover.miapicturebackend.model.dto.search.SearchRequest searchRequest = new com.lumenglover.miapicturebackend.model.dto.search.SearchRequest();
                ...
                try {
                    ...
                    if (records != null && !records.isEmpty()) {
                        ...
                        for (Object record : records) {
                            if (record instanceof com.lumenglover.miapicturebackend.model.vo.PictureVO) {
                                com.lumenglover.miapicturebackend.model.vo.PictureVO pic = (com.lumenglover.miapicturebackend.model.vo.PictureVO) record;
