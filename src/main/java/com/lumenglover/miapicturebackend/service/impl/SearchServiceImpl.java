...
import com.lumenglover.miapicturebackend.mapper.HotSearchMapper;
import com.lumenglover.miapicturebackend.mapper.UserSearchRecordMapper;
import com.lumenglover.miapicturebackend.model.dto.search.SearchRequest;
import com.lumenglover.miapicturebackend.model.entity.*;
import com.lumenglover.miapicturebackend.model.enums.SpaceLevelEnum;
import com.lumenglover.miapicturebackend.model.vo.*;
import com.lumenglover.miapicturebackend.service.*;
import com.lumenglover.miapicturebackend.utils.DomainReplaceUtil;
...
public class SearchServiceImpl implements SearchService {
    ...
    private Page<PictureVO> searchPicture(SearchRequest searchRequest) {
        ...
        if (Boolean.TRUE.equals(searchRequest.getEnableSemanticSearch()) && StringUtils.isNotBlank(searchText)) {
            com.lumenglover.miapicturebackend.model.dto.picture.SearchPictureBySemanticRequest semanticReq = new com.lumenglover.miapicturebackend.model.dto.picture.SearchPictureBySemanticRequest();
            ...
            com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.lumenglover.miapicturebackend.model.vo.PictureVO> semanticResult = pictureService.searchPictureBySemantic(semanticReq, request);
