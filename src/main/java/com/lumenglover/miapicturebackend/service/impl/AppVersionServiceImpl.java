...
import com.lumenglover.miapicturebackend.mapper.AppVersionMapper;
import com.lumenglover.miapicturebackend.model.entity.User;
import com.lumenglover.miapicturebackend.service.AppVersionService;
...
public class AppVersionServiceImpl extends ServiceImpl<AppVersionMapper, AppVersion> implements AppVersionService {
    ...
    public void uploadNewVersion(MultipartFile file, AppVersion appVersion, User loginUser) {
        ...
        // 上传文件
        String fileName = "mia_" + appVersion.getVersion() + ".apk";
