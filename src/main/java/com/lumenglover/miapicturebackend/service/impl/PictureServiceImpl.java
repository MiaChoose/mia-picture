...
import com.lumenglover.miapicturebackend.api.aliyunai.AliYunAiApi;
import com.lumenglover.miapicturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
import com.lumenglover.miapicturebackend.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.lumenglover.miapicturebackend.constant.CrawlerConstant;
import com.lumenglover.miapicturebackend.constant.RedisConstant;
...
import com.lumenglover.miapicturebackend.manager.CosManager;
import com.lumenglover.miapicturebackend.manager.CrawlerManager;
import com.lumenglover.miapicturebackend.manager.RecommendationManager;
import com.lumenglover.miapicturebackend.manager.auth.SpaceUserAuthManager;
import com.lumenglover.miapicturebackend.manager.auth.model.SpaceUserPermissionConstant;
import com.lumenglover.miapicturebackend.manager.upload.FilePictureUpload;
import com.lumenglover.miapicturebackend.manager.upload.PictureUploadTemplate;
import com.lumenglover.miapicturebackend.manager.upload.UrlPictureUpload;
import com.lumenglover.miapicturebackend.mapper.ChatMessageMapper;
import com.lumenglover.miapicturebackend.mapper.PictureMapper;
import com.lumenglover.miapicturebackend.model.dto.file.UploadPictureResult;
import java.util.HashSet;
import java.util.Set;
import com.lumenglover.miapicturebackend.model.dto.picture.*;
import com.lumenglover.miapicturebackend.model.dto.spaceuser.SpaceUserQueryRequest;
import com.lumenglover.miapicturebackend.model.entity.*;
import com.lumenglover.miapicturebackend.model.enums.OperationEnum;
import com.lumenglover.miapicturebackend.model.enums.PictureReviewStatusEnum;
import com.lumenglover.miapicturebackend.model.vo.PictureTagCategory;
import com.lumenglover.miapicturebackend.model.vo.PictureVO;
import com.lumenglover.miapicturebackend.model.vo.UserVO;
import com.lumenglover.miapicturebackend.service.*;
import com.lumenglover.miapicturebackend.model.entity.LikeRecord;
import com.lumenglover.miapicturebackend.model.entity.FavoriteRecord;
import com.lumenglover.miapicturebackend.model.entity.ViewRecord;
import com.lumenglover.miapicturebackend.utils.ColorSimilarUtils;
import com.lumenglover.miapicturebackend.utils.ColorTransformUtils;
import com.lumenglover.miapicturebackend.utils.EmailSenderUtil;
import com.lumenglover.miapicturebackend.utils.SystemNotifyUtil;
import com.lumenglover.miapicturebackend.utils.TencentCloudImageAuditUtil;
import com.lumenglover.miapicturebackend.utils.SensitiveUtil;
import com.lumenglover.miapicturebackend.utils.PicturePermissionUtils;
import com.lumenglover.miapicturebackend.config.CosClientConfig;
import com.lumenglover.miapicturebackend.service.PythonRagService;
import com.lumenglover.miapicturebackend.model.dto.rag.PythonRagResponse;
import com.qcloud.cos.model.ciModel.auditing.ImageAuditingResponse;
import lombok.extern.slf4j.Slf4j;
import com.lumenglover.miapicturebackend.model.dto.viewrecord.ViewRecordAddRequest;
import com.lumenglover.miapicturebackend.service.ViewRecordService;
...
import com.lumenglover.miapicturebackend.manager.auth.StpKit;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    @Resource
    private com.lumenglover.miapicturebackend.utils.PictureScoreUpdateTracker pictureScoreUpdateTracker;

    @Resource
    private com.lumenglover.miapicturebackend.api.pexels.PexelsApiClient pexelsApiClient;

    @Resource
    private PythonRagService pythonRagService;

    @Resource
    private com.lumenglover.miapicturebackend.manager.websocket.BatchUploadWebSocketHandler batchUploadWebSocketHandler;
    ...
    @Resource
    private com.lumenglover.miapicturebackend.service.PexelsCrawlRecordService pexelsCrawlRecordService;
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        try {
            ...
            com.lumenglover.miapicturebackend.api.pexels.model.PexelsSearchResponse searchResponse = pexelsApiClient
            ...
            // 过滤掉已经在爬取记录里存在的重复图片
            List<com.lumenglover.miapicturebackend.api.pexels.model.PexelsPhoto> rawPhotos = searchResponse
                    .getPhotos();
            List<com.lumenglover.miapicturebackend.api.pexels.model.PexelsPhoto> photos = new ArrayList<>();
            for (com.lumenglover.miapicturebackend.api.pexels.model.PexelsPhoto p : rawPhotos) {
            ...
            List<com.lumenglover.miapicturebackend.api.pexels.model.PexelsPhoto> targetPhotos = photos.subList(0,
                    targetCount);

            List<String> englishTitles = new ArrayList<>();
            List<String> englishDescriptions = new ArrayList<>();

            for (com.lumenglover.miapicturebackend.api.pexels.model.PexelsPhoto photo : targetPhotos) {
            ...
            for (int i = 0; i < targetPhotos.size() && uploadCount < count; i++) {
                com.lumenglover.miapicturebackend.api.pexels.model.PexelsPhoto photo = targetPhotos.get(i);
                ...
                try {
                    ...
                    // 记录抓取历史，防止后续再次重复抓取
                    try {
                        com.lumenglover.miapicturebackend.model.entity.PexelsCrawlRecord record = new com.lumenglover.miapicturebackend.model.entity.PexelsCrawlRecord();
    ...
    @Resource
    private com.lumenglover.miapicturebackend.service.AliYunAiService aliYunAiService;

    @Resource
    private io.qdrant.client.QdrantClient qdrantClient;

    @org.springframework.beans.factory.annotation.Value("${qdrant.collection-name:mia_picture}")
    ...
    public Page<PictureVO> searchPictureBySemantic(SearchPictureBySemanticRequest searchPictureBySemanticRequest,
        ...
        try {
            ...
            List<Picture> pictureList = this.list(new QueryWrapper<Picture>()
                    ...
                    .eq("isDraft", 0)
                    .eq("reviewStatus",
                            com.lumenglover.miapicturebackend.model.enums.PictureReviewStatusEnum.PASS.getValue()));
                ...
                if (CollUtil.isNotEmpty(results)) {
                    ...
                    if (CollUtil.isNotEmpty(picIds)) {
                        List<Picture> pictureList = this.list(new QueryWrapper<Picture>()
                                ...
                                .eq("isDraft", 0)
                                .eq("reviewStatus",
                                        com.lumenglover.miapicturebackend.model.enums.PictureReviewStatusEnum.PASS
                                                .getValue()));
