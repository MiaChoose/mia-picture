...
import com.lumenglover.miapicturebackend.mapper.UserfollowsMapper;
...
import com.lumenglover.miapicturebackend.service.PrivateChatService;
...
public class UserFollowsServiceImpl extends ServiceImpl<UserfollowsMapper, Userfollows>
    ...
    public Boolean addUserFollows(UserFollowsAddRequest userFollowsAddRequest) {
        ...
        if (followStatus == 1) {
            ...
            } else if (userFollows.getFollowStatus() == 0) {
                isNewFollow = true;
            }
            userFollows.setFollowStatus(1);
            ...
            if (isNewFollow) {
                ...
                if (followerUser != null) {
                    ...
                    notify.setNotifyType("INTERACTION");
                    notify.setSenderType("USER");
                    notify.setSenderId(followerId.toString());
                    notify.setReceiverType("SPECIFIC_USER");
                    notify.setReceiverId(followingId.toString());
                    notify.setTitle("新增关注");
                    notify.setContent("用户【" + followerUser.getUserName() + "】关注了你");
                    notify.setRelatedBizType("USER");
                    notify.setRelatedBizId(followerId.toString());
