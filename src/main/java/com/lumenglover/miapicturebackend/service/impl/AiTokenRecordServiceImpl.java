...
import com.lumenglover.miapicturebackend.mapper.AiTokenRecordMapper;
import com.lumenglover.miapicturebackend.model.entity.AiTokenRecord;
...
import com.lumenglover.miapicturebackend.manager.websocket.AiTokenWebSocketHandler;
...
public class AiTokenRecordServiceImpl extends ServiceImpl<AiTokenRecordMapper, AiTokenRecord> implements AiTokenRecordService {
    ...
    @Override
    public com.lumenglover.miapicturebackend.model.vo.AiTokenUsageVO getTokenUsage(Long userId) {
        User user = userService.getById(userId);
        if (user == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR, "用户不存在");
        }
        ...
        // 4. 统计本周生图额度及使用量
        com.lumenglover.miapicturebackend.model.enums.AiTokenQuotaEnum quotaEnum =
            com.lumenglover.miapicturebackend.model.enums.AiTokenQuotaEnum.getEnumByValue(isAdmin ? 2 : memberType);
        if (quotaEnum == null) {
            quotaEnum = com.lumenglover.miapicturebackend.model.enums.AiTokenQuotaEnum.NORMAL;
        }
        ...
        com.lumenglover.miapicturebackend.model.vo.AiTokenUsageVO vo = new com.lumenglover.miapicturebackend.model.vo.AiTokenUsageVO();
