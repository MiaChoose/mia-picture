...
public interface PostService extends IService<Post> {
     ...
     * @return 帖子数据列表
     */
    List<com.lumenglover.miapicturebackend.model.dto.post.PostHotScoreDto> selectPostScoreData(long offset, long pageSize);
     ...
     * @return 帖子数据列表
     */
    List<com.lumenglover.miapicturebackend.model.dto.post.PostHotScoreDto> selectPostScoreDataInRange(long minId, long maxId, long offset, long pageSize);
}
