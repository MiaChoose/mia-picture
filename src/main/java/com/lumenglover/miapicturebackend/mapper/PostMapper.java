...
public interface PostMapper extends BaseMapper<Post> {
     ...
     * @return 帖子数据列表
     */
    List<com.lumenglover.miapicturebackend.model.dto.post.PostHotScoreDto> selectPostScoreData(@Param("offset") long offset, @Param("pageSize") long pageSize);
     ...
     * @return 帖子数据列表
     */
    List<com.lumenglover.miapicturebackend.model.dto.post.PostHotScoreDto> selectPostScoreDataInRange(@Param("minId") long minId, @Param("maxId") long maxId, @Param("offset") long offset, @Param("pageSize") long pageSize);
}
